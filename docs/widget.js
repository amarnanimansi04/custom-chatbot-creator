(function () {
    ...
    document.body.insertAdjacentHTML("beforeend", `
      ...
      <div id="cchat-box">
        <div id="cchat-header">💬 Indus Odyssey </div>
    ...
    function sendMessage() {
      ...
      function doFetch(retries) {
        ...
        fetch(API_URL + "/api/chat", {
          ...
          body: JSON.stringify({ chatbot_id: CHATBOT_ID, session_id: sessionId, message: msg }),
        ...
        .catch(err => {
          ...
          if (retries > 0) {
            typing.textContent = "Retrying...";
            setTimeout(() => doFetch(retries - 1), 2000);
          } else {
